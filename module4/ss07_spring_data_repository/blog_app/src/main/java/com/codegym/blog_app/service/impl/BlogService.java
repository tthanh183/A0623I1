...
public class BlogService implements IBlogService {
    ...
    @Override
    public Page<Blog> findBlogByCategoryAndTitle(Category category, String title, Pageable pageable) {
        return blogRepository.findBlogByCategoryAndTitle(category,"%"+ title + "%",pageable);
    }
}
